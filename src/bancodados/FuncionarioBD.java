        ...
        */
            ...
            sql = "INSERT INTO QUICKER.FUNCIONARIOS (NOMEFUNCIONARIO, CPFFUNCIONARIO, DATANASCIMENTOFUNCIONARIO, PISFUNCIONARIO, TELEFONEFUNCIONARIO, CELULARFUNCIONARIO, CEPFUNCIONARIO, RUAAVNFUNCIONARIO, NUMEROFUNCIONARIO, BAIRROFUNCIONARIO, CIDADEFUNCIONARIO, ESTADOFUNCIONARIO, DATAADIMISSAOFUNCIONARIO, SITUACAOFUNCIONARIO, DATADEMISSAOFUNCIONARIO, DATAAFASTAMENTOFUNCIONARIO, DATARETORNOFUNCIONARIO, CARGOFUNCIONARIO, NIVELPERMISSAOFUNCIONARIO, NOMEUSUARIOFUNCIONARIO, SENHAFUNCIONARIO)" +
                  ...
                  " VALUES ('"+funcionarioRecebido.getNomeFuncionario()+"', "
                              ...
                              + "'"+funcionarioRecebido.getDataNascimentoFuncionario().get(Calendar.YEAR)+"-"+formatador.format(funcionarioRecebido.getDataNascimentoFuncionario().get(Calendar.MONTH)+1)+"-"+formatador.format(funcionarioRecebido.getDataNascimentoFuncionario().get(Calendar.DAY_OF_MONTH))+"', "
                              ...
                              + "'"+funcionarioRecebido.getDataAdamissaoFuncionario().get(Calendar.YEAR)+"-"+ formatador.format(funcionarioRecebido.getDataAdamissaoFuncionario().get(Calendar.MONTH)+1)+"-"+formatador.format(funcionarioRecebido.getDataAdamissaoFuncionario().get(Calendar.DAY_OF_MONTH))+"', "
                              + "'"+funcionarioRecebido.getSituacaoFuncionario()+ "', ";
                      
                    // --- condições para as datas 
            
                    if(funcionarioRecebido.getDataDemissaoFuncionario()!= null) {
                        sql += "'"+funcionarioRecebido.getDataDemissaoFuncionario().get(Calendar.YEAR)+"-"+formatador.format( funcionarioRecebido.getDataDemissaoFuncionario().get(Calendar.MONTH)+1)+"-"+formatador.format(funcionarioRecebido.getDataDemissaoFuncionario().get(Calendar.DAY_OF_MONTH))+ "', ";
            } else {
                        sql += "null,";
            }
                    ...
                    if(funcionarioRecebido.getDataRetornoFuncionario()!= null) {
                        sql += "'"+funcionarioRecebido.getDataRetornoFuncionario().get(Calendar.YEAR)+"-"+ formatador.format(funcionarioRecebido.getDataRetornoFuncionario().get(Calendar.MONTH)+1)+"-"+formatador.format(funcionarioRecebido.getDataRetornoFuncionario().get(Calendar.DAY_OF_MONTH))+ "', ";
            } else {
                        sql += "null,";
            }      
   ...
   public ArrayList<Funcionario> selecionarTodosFuncionarios()
    {
        ...
        try
        {
             ...
             while(tabelaRetornada.next()) // Enquanto houverem linhas na tabela para serem lidas
            {
                ...
                funcionario.setPermissaoFuncionario(tabelaRetornada.getString("NIVELPERMISSAOFUNCIONARIO"));
                funcionario.setNomeUsuario(tabelaRetornada.getString("NOMEUSUARIOFUNCIONARIO"));
                funcionario.setSenhaFuncionario(tabelaRetornada.getString("SENHAFUNCIONARIO"));
