...
public class TelaPrincipal extends javax.swing.JFrame {
         ...
         // ActionListener para captura e demonstração da hora atual
    ActionListener relogioSistema = new ActionListener()
        {
            @Override
            public void actionPerformed(ActionEvent e) {
                 cal = Calendar.getInstance();

                 lbHora.setText(formatador.format(cal.get(Calendar.HOUR_OF_DAY))+":"+formatador.format(cal.get(Calendar.MINUTE))+":"+formatador.format(cal.get(Calendar.SECOND)));  
                 lbData.setText(formatador.format(cal.get(Calendar.DAY_OF_MONTH))+"/"+formatador.format(cal.get(Calendar.MONTH))+"/"+formatador.format(cal.get(Calendar.YEAR)));
            }
        };
    ...
    public TelaPrincipal() {
        initComponents();
         ...
         // Threads de TIMER para a janela...
        Timer relogio = new Timer(1000, relogioSistema);
        relogio.start();
        
        /* OCULTANDO TELA INTERNA DE GERENCIAR PRODUTO ESTOQUE */
        miGerenciarProduto.setVisible(false);
        ifTelaProdutoEstoque.setVisible(false);
        
        /* OCULTANDO TELA INTERNA DE VENDA - PDV */
        miPDV.setEnabled(false);
        ifTelaPdv.setVisible(false);
        lbPdv.setVisible(false);
...
//         Login();
        ...
        btCancelarFuncionario.setVisible(false);
        btCancelarFornecedor.setVisible(false);
    ...
    private void initComponents() {
        ...
        btCancelarCliente1 = new javax.swing.JButton();
        ...
        btRemoverProdutoEstoque = new javax.swing.JButton();
        ...
        tbMenus = new javax.swing.JToolBar();
        ...
        tfNomeCompletoFuncionario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNomeCompletoFuncionarioActionPerformed(evt);
            }
        });
        ...
        tfNomeUsuarioFuncionario.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tfNomeUsuarioFuncionarioKeyReleased(evt);
            }
        });
        ...
        btCancelarFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Cancel.png"))); // NOI18N
        btCancelarFuncionario.setText("Cancelar");
        btCancelarFuncionario.setToolTipText("Limpar Todos Os Campos.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btCancelarFuncionario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        ifTelaFuncionario.setBounds(590, 80, 570, 580);
        ...
        tfRazaoSocialFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfRazaoSocialFornecedorActionPerformed(evt);
            }
        });
        ...
        tfNomeFantasiaFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNomeFantasiaFornecedorActionPerformed(evt);
            }
        });
        ...
        ftfCnpjFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfCnpjFornecedorActionPerformed(evt);
            }
        });
        ftfCnpjFornecedor.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ftfCnpjFornecedorFocusLost(evt);
            }
        });

        ftfTelefoneFornecedor.setToolTipText("OBRIGATORIO");
        ftfTelefoneFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfTelefoneFornecedorActionPerformed(evt);
            }
        });
        ...
        ftfCepFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfCepFornecedorActionPerformed(evt);
            }
        });
        ...
        tfLogradouroFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfLogradouroFornecedorActionPerformed(evt);
            }
        });

        tfNumeroFornecedor.setToolTipText("NÚMERO DO ENDEREÇO - OBRIGATORIO");
        tfNumeroFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNumeroFornecedorActionPerformed(evt);
            }
        });

        tfBairroFornecedor.setToolTipText("OBRIGATORIO");
        tfBairroFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfBairroFornecedorActionPerformed(evt);
            }
        });
        ...
        btCancelarFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Cancel.png"))); // NOI18N
        btCancelarFornecedor.setText("Cancelar");
        btCancelarFornecedor.setToolTipText("Limpar Todos Os Campos.");
        ...
        ftfTelefoneRepresentnteFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfTelefoneRepresentnteFornecedorActionPerformed(evt);
            }
        });

        ftfCelularRepresentanteFornecedor.setToolTipText("NÚMERO DE TELEFONE CELULAR DO REPRESENTANTE - OBRIGATORIO");
        ftfCelularRepresentanteFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfCelularRepresentanteFornecedorActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btCancelarFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(272, 272, 272)
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        btNovoProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/add25x25BLUE.png"))); // NOI18N
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel19Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btNovoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(67, 67, 67))))
        );
        ...
        btSalvarCliente1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSalvarCliente1ActionPerformed(evt);
            }
        });
        ...
        btCancelarCliente1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Cancel.png"))); // NOI18N
        btCancelarCliente1.setText("Cancelar");
        btCancelarCliente1.setToolTipText("Limpar Todos Os Campos.");
                ...
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel18Layout.createSequentialGroup()
                        .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btCancelarCliente1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(272, 272, 272)
                        .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jPanel18Layout.setVerticalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                ...
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btCancelarCliente1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tfBuscaProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfBuscaProdutoActionPerformed(evt);
            }
        });
        tfBuscaProduto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tfBuscaProdutoKeyReleased(evt);
            }
        });
        ...
        btRemoverProdutoEstoque.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icones-pequenos-3/delete.png"))); // NOI18N
        btRemoverProdutoEstoque.setText("Remover");
        btRemoverProdutoEstoque.setToolTipText("Selecione O Funcionario Que Deseja Excluir.");
        btRemoverProdutoEstoque.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btRemoverProdutoEstoqueActionPerformed(evt);
            }
        });
        ...
        jPanel20Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                ...
                .addComponent(btRemoverProdutoEstoque)
                .addGap(18, 18, 18)
        ...
        tfNomeCompletoCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfNomeCompletoClienteFocusLost(evt);
            }
        });
        ...
        ftfCpfCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ftfCpfClienteFocusLost(evt);
            }
        });
        ...
        ftfTelefoneCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ftfTelefoneClienteFocusLost(evt);
            }
        });

        ftfCelularCliente.setToolTipText("OBRIGATORIO");
        ftfCelularCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ftfCelularClienteFocusLost(evt);
            }
        });

        tfLogradouroCliente.setToolTipText("NOME RUA/AVENIDA - OBRIGATORIO");
        tfLogradouroCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfLogradouroClienteFocusLost(evt);
            }
        });
        ...
        tfNumeroCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfNumeroClienteFocusLost(evt);
            }
        });
        ...
        tfComplementoCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfComplementoClienteFocusLost(evt);
            }
        });
        ...
        tfEmailCliente.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfEmailClienteFocusLost(evt);
            }
        });
        ...
        tbMenus.setRollover(true);
        tbMenus.setBorderPainted(false);
        tbMenus.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
                tbMenusAncestorRemoved(evt);
            }
        });
        ...
        tbMenus.add(lbLogoff);

        jLabel66.setText("          ");
        tbMenus.add(jLabel66);

        lbData.setText("/ /");
        tbMenus.add(lbData);

        jLabel67.setText("          ");
        tbMenus.add(jLabel67);

        lbHora.setText(" -- 16:09 --");
        tbMenus.add(lbHora);

        dpAreaTrabalho.add(tbMenus);
        tbMenus.setBounds(980, 10, 330, 60);
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/pizza.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(dpAreaTrabalho, javax.swing.GroupLayout.DEFAULT_SIZE, 2037, Short.MAX_VALUE)
        );
    ...
    private void miSobreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miSobreActionPerformed
        ...
        telaSobre.setTitle("SOBRE SISTEMA QUICKER");
    ...
    public void Login()
    {
        ...
        if(telaLogin.permissaoUsuario.equalsIgnoreCase("Usuario") && telaLogin.situacao.equalsIgnoreCase("Contratado"))
        {
            tpnAbasFuncionario.setEnabledAt(0, false);
            tpnAbasProdutoEstoque.setEnabledAt(1, false);
        }
    }
    ...
    private void miCadastrarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCadastrarProdutoActionPerformed
        ...
        //TelaCadastrarProduto telaPizza=new TelaCadastrarProduto(this, true);
    ...
    private void miGerenciarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miGerenciarClienteActionPerformed
        ...
        ifTelaCliente.setVisible(true);
        ifTelaCliente.setTitle("GERÊNCIAR CLIENTES");
        ifTelaCliente.setLocation(80, 80);
        /* SOBREPOR A TELA, CASO TENHA OUTRAS ABERTAS*/
        try{
            ifTelaCliente.setSelected(true);
    ...
    private void miGerenciarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miGerenciarFuncionarioActionPerformed
        ...
        ifTelaFuncionario.setVisible(true);
        ifTelaFuncionario.setTitle("GERÊNCIAR FUNCIONARIOS");
        ifTelaFuncionario.setLocation(40, 40);
        /* SOBREPOR A TELA, CASO TENHA OUTRAS ABERTAS*/
        try{
            ifTelaFuncionario.setSelected(true);
    ...
    private void btSalvarAtualizarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarAtualizarFuncionarioActionPerformed
        ...
        {
            funcionarioNovo = retornarDadosPreenchidosFuncionario();
        ...
        // Confirmando se o usuário REALMENTE deseja alterar
            int resp = JOptionPane.showConfirmDialog(this, 
                                                                ...
                                                                + "<TABLE border='1'> "
                                                                        ...
                                                                        + "<TR> <TD> NOME: "+funcionarioAntigo.getNomeFuncionario()+" </TD> <TD> NOME: "+funcionarioNovo.getNomeFuncionario()+" </TD> </TR>"
                                                                        +"<TR> <TD>  CPF: "+funcionarioAntigo.getCpfFuncionario()+"</TD> <TD> CPF: "+funcionarioNovo.getCpfFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  DATA DE NASCIMENTO: "+formatador.format(funcionarioAntigo.getDataNascimentoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"
                                                                        +formatador.format(funcionarioAntigo.getDataNascimentoFuncionario().get(Calendar.MONTH))+"/"+
                                                                        funcionarioAntigo.getDataNascimentoFuncionario().get(Calendar.YEAR)+"</TD> <TD> DATA DE NASCIMENTO: "+formatador.format(funcionarioNovo.getDataNascimentoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"+
                                                                        formatador.format(funcionarioNovo.getDataNascimentoFuncionario().get(Calendar.MONTH))+"/"
                                                                        + funcionarioNovo.getDataNascimentoFuncionario().get(Calendar.YEAR)+"</TD> </TR>"
                                                                        +"<TR> <TD>  CELULAR: "+funcionarioAntigo.getCelularFuncionario()+"</TD> <TD> CELULAR: "+funcionarioNovo.getCelularFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  CEP: "+funcionarioAntigo.getCepFuncionario()+"</TD> <TD> CEP: "+funcionarioNovo.getCepFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  LOGRADOURO: "+funcionarioAntigo.getRuaAvnFuncionario()+"</TD> <TD> LOGRADOURO "+funcionarioNovo.getRuaAvnFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  NÚMERO: "+funcionarioAntigo.getNumeroFuncionario()+"</TD> <TD> NÚMERO: "+funcionarioNovo.getNumeroFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  BAIRRO: "+funcionarioAntigo.getBairroFuncionario()+"</TD> <TD> BAIRRO: "+funcionarioNovo.getBairroFuncionario()+"</TD> </TR>"
                                                                        +"<TR> <TD>  CIDADE: "+funcionarioAntigo.getCidadeFuncionario()+"</TD> <TD> CIDADE: "+funcionarioNovo.getCidadeFuncionario()+"</TD> </TR> "
                                                                        + "<TR> <TD> ESTADO: "+funcionarioAntigo.getEstadoFuncionario()+" </TD> <TD> EMAIL: "+funcionarioNovo.getEstadoFuncionario()+" </TD> </TR>"
                                                                        + "<TR> <TD> DATA DE ADMISSÃO: "+formatador.format(funcionarioAntigo.getDataAdamissaoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"
                                                                        +formatador.format(funcionarioAntigo.getDataAdamissaoFuncionario().get(Calendar.MONTH))+"/"+
                                                                        funcionarioAntigo.getDataAdamissaoFuncionario().get(Calendar.YEAR)+
                                                                        " </TD> <TD>  DATA DE ADMISSÃO: "+formatador.format(funcionarioNovo.getDataAdamissaoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"+
                                                                         formatador.format(funcionarioNovo.getDataAdamissaoFuncionario().get(Calendar.MONTH))+"/"
                                                                        + funcionarioNovo.getDataAdamissaoFuncionario().get(Calendar.YEAR)+" </TD> </TR> "
                                                                        +"<TR> <TD>  SITUAÇÃO: "+funcionarioAntigo.getSituacaoFuncionario()+"</TD> <TD> SITUAÇÃO: "+funcionarioNovo.getSituacaoFuncionario()+"</TD> </TR> "
                                                                        + "<TR> <TD> DATA DE DEMISSÃO: "+formatador.format(funcionarioAntigo.getDataDemissaoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"
                                                                        +formatador.format(funcionarioAntigo.getDataDemissaoFuncionario().get(Calendar.MONTH))+"/"+
                                                                        funcionarioAntigo.getDataDemissaoFuncionario().get(Calendar.YEAR)+
                                                                        " </TD> <TD>  DATA DE ADMISSÃO: "+formatador.format(funcionarioNovo.getDataDemissaoFuncionario().get(Calendar.DAY_OF_MONTH))+"/"+
                                                                         formatador.format(funcionarioNovo.getDataDemissaoFuncionario().get(Calendar.MONTH))+"/"
                                                                        + funcionarioNovo.getDataDemissaoFuncionario().get(Calendar.YEAR)+" </TD> </TR> "
                                                                        + "<TR> <TD> CARGO: "+funcionarioAntigo.getCargoFuncionario()+" </TD> <TD> CARGO: "+funcionarioNovo.getCargoFuncionario()+" </TD> </TR>"
                                                                        + "</TABLE>"
                                                                        + "</HTML>", 
        ...
        if( resp == 0)
        {
                conexaoTabelaFuncionario.atualizarFuncionario(retornarDadosPreenchidosFuncionario(), funcionarioAntigo);
                ...
                tbListaFuncionarios.updateUI();
                tpnAbasFuncionario.setSelectedIndex(0);
                tpnAbasFuncionario.setTitleAt(0, "CADASTRAR FUNCIONARIO");
                tpnAbasFuncionario.setEnabledAt(0, true); 
                tpnAbasFuncionario.setEnabledAt(1, true); 
               
                btSalvarAtualizarFuncionario.setVisible(false);
                btCancelarFuncionario.setVisible(false);  
                btSalvarAtualizarFuncionario.setVisible(true);
                btLimparCamposFuncionario.setVisible(true);
            ...
            if(resp==1)// se precionar NÃO, manter a tela  preenchida
                {
                            ...
                            btCancelarFuncionario.setVisible(true);
                            btSalvarAtualizarCliente.setVisible(false);
                            btLimparCamposFuncionario.setVisible(false); 
                } else
                  {
                    ...
                    tpnAbasFuncionario.setEnabledAt(0, true); 
                    tpnAbasFuncionario.setEnabledAt(1, true); 
                    tpnAbasFuncionario.setTitleAt(1,"GERÊNCIAR FUNCIONARIO");
                    btSalvarAtualizarFuncionario.setVisible(false);
                    btSalvarFuncionario.setVisible(true);
                    btCancelarFuncionario.setVisible(false);
                    btLimparCamposFuncionario.setVisible(true);
 ...
 */
    private void cbSituacaoFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSituacaoFuncionarioActionPerformed
        ...
        if(cbSituacaoFuncionario.getSelectedItem().toString().equalsIgnoreCase("Contratado"))
        {
            ...
            if(cbSituacaoFuncionario.getSelectedItem().toString().equalsIgnoreCase("Demitido"))
            {
                ...
                lbDataRetornoFuncionario.setVisible(false);
                ftfDataRetornoFuncionario.setVisible(false);
                tfNomeUsuarioFuncionario.setEditable(false);
                tfSenhaFuncionario.setEnabled(false);
                tfSenhaFuncionario.setText("demitido");
            }else
    ...
    private void miCadastrarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCadastrarFornecedorActionPerformed
        ...
        {
                tfIdFornecedor.setText(listaFornecedores.size()+1+" ");
        }
        
        tpnAbasFornecedor.setSelectedIndex(0);
        ifTelaFornecedor.setVisible(true);
        ifTelaFornecedor.setTitle("CADASTRAR FORNECEDOR");
    ...
    private void miGerenciarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miGerenciarFornecedorActionPerformed
        ...
        ifTelaFornecedor.setVisible(true);
        ifTelaFornecedor.setTitle("GERÊNCIAR FORNECEDOR");
        ifTelaFornecedor.setLocation(0, 0);
        /* SOBREPOR A TELA, CASO TENHA OUTRAS ABERTAS*/
        try{
            ifTelaFornecedor.setSelected(true);
 ...
 */
    private void btNovoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoProdutoActionPerformed
       ...
       // telaNovoProduto.setLocation(null);
...
//        ftfValorTroco.setValue(troco+"");
    ...
    public void verificarCpfCliente()
    {
        ...
        for(int i=0; i<listaClientes.size();i++)
        {
            if(ftfCpfCliente.getText().equals(listaClientes.get(i).getCpfCliente()))
            {
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if((( JOptionPane.showConfirmDialog(rootPane, "DESEJA FAZER LOGOOF?", "TROCAR USUARIO/SAIR", 0)) == 0))
        {
            fazerLogoff();
        }
    ...
    private void btCancelarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarFuncionarioActionPerformed
            tpnAbasFuncionario.setTitleAt(0, "GERÊNCIAR FUNCIONARIO");
            tpnAbasFuncionario.setEnabledAt(0, true); 
            tpnAbasFuncionario.setEnabledAt(1, true); 
            tpnAbasFuncionario.setTitleAt(1,"CADASTRAR FUNCIONARIO");
    ...
    private void miGerenciarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miGerenciarProdutoActionPerformed
        // TODO add your handling code here:
         ...
         ifTelaProdutoEstoque.setVisible(true);
         ifTelaProdutoEstoque.setTitle("GERÊNCIAR PRODUTOS");
    ...
    private void btRemoverFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverFornecedorActionPerformed
        ...
        {
           int resp= JOptionPane.showConfirmDialog(ifTelaFornecedor, "<HTML><b> DESEJA REALEMENTE EXCLUIR</b>?<HTML>", "CONFIRMAÇÃO", 0, 3);
           if(resp==0) 
           {
    ...
    private void btRemoverFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverFuncionarioActionPerformed
        ...
        {
             int resp= JOptionPane.showConfirmDialog(ifTelaFuncionario, "<HTML><b> DESEJA REALEMENTE EXCLUIR</b>?<HTML>", "CONFIRMAÇÃO", 0, 3);
           if(resp==0) 
           {
    ...
    private void btRemoverClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverClienteActionPerformed
        ...
        {
             int resp= JOptionPane.showConfirmDialog(ifTelaCliente, "<HTML><b> DESEJA REALEMENTE EXCLUIR</b>?<HTML>", "CONFIRMAÇÃO", 0, 3);
           if(resp==0) 
           {
          // comando gigante para excluir funcionarioAntigo
         ...
         int posicaoSelecionada;
            switch(tipoRelatorio)
            {
                case "cliente": 
                    ...
                    if(tbListaClientes.getSelectedRow()!=-1) // Se existe alguma linha selecionada, faça...
                    {
                        posicaoSelecionada=tbListaClientes.getSelectedRow();

                        Calendar cal = listaClientes.get(posicaoSelecionada).getDataNascimentoCliente();
                        
                           JOptionPane.showMessageDialog(ifTelaCliente, 
                            "<HTML>"
                           +"<CENTER> -- <b> DADOS DO CLIENTE -- </b><br><br></CENTER>"
                           +"<table>"
                           +"<tr><td><b>NOME COMPLETO:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getNomeCliente()+"</td></tr>"
                           +"<tr><td><b>DATA DE NASCIMENTO:</b></td> <td> "+formatador.format(cal.get(Calendar.DAY_OF_MONTH))+"/"+formatador.format(cal.get(Calendar.MONTH))+"/"+cal.get(Calendar.YEAR)+"</td></tr>"
                           +"<tr><td><b>TELEFONE FIXO:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getDataNascimentoCliente().getTime()+"</td></tr>"
                           +"<tr><td>TELEFONE CELULAR:</td> <td>"+listaClientes.get(posicaoSelecionada).getCelularCliente()+"</td></tr>"
                           +"<tr><td><b>CEP:</b></td> <td>" +listaClientes.get(posicaoSelecionada).getCepCliente()+"</td></tr>"
                           +"<tr><td><b>LOGRADOURO:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getRuaAvnCliente()+"</td></tr>"
                           +"<tr><td><b>BAIRRO:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getBairroCliente()+"</td></tr>"
                           +"<tr><td><b>CIDADE:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getCidadeCliente()+"</td></tr>"
                           +"<tr><td><b>COMPLEMENTO:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getComplementoCliente()+"</td></tr>"
                           +"<tr><td><b>E-MAIL:</b></td> <td> "+listaClientes.get(posicaoSelecionada).getEmailCliente()+"</td></tr>"
                           +"</table></html>"
                           );

                    }else
                    {
                         JOptionPane.showMessageDialog(rootPane, listaClientes.size());
                    }
                    break;
                ...
                case "fornecedor":
                    ...
                    if(tbListaFornecedores.getSelectedRow()!=-1) // Se existe alguma linha selecionada, faça...
                    {
                        posicaoSelecionada=tbListaFornecedores.getSelectedRow();
                        // FORNECEDOR SELECIONADO

                           JOptionPane.showMessageDialog(ifTelaFornecedor, 
                           "<HTML>"
                           +"<CENTER> -- <b> DADOS DO FORNECEDOR -- </b><br><br></CENTER>"
                           +"<table> "
                           +"<tr><td><b>NOME FANTASIA:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getNomeFantasiaFornecedor()
                           +"<tr><td><b>RAZÃO SOCIAL:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getRazaoSocialFornecedor()+"</td></tr>"
                           +"<tr><td><b>TELFONE:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getTelefoneFornecedor()+"</td></tr>"
                           +"<tr><td><b>LOGRADOURO:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getRuaAvnFornecedor()+"</td></tr>"
                           +"<tr><td><b>BAIRRO:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getBairroFornecedor()+"</td></tr>"
                           +"<tr><td><b>CIDADE:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getCidadeFornecedor()+"</td></tr>"
                           +"<tr><td colspan='2'><CENTER> -- <b> DADOS DO REPRESENTANTE -- </b><br><br></CENTER></td></tr>"
                           +"<tr><td><b>REPRESENTANTE:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getRepresentanteFornecedor()+"</td></tr>"
                           +"<tr><td><b>TELEFONE:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getTelefoneRepresentanteFornecedor()+"</td></tr>"
                           +"<tr><td><b>CELULAR:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getCelularRepresentanteFornecedor()+"</td></tr>"
                           +"<tr><td><b>E-MAIL:</b></td> <td>"+listaFornecedores.get(posicaoSelecionada).getEmailRepresentanteFornecedor()+"</td></tr>"
                           +"</table></html>"
                           );
                ...
                case "funcionario":
                    String senha;
                     ...
                     if(tbListaFuncionarios.getSelectedRow()!=-1) // Se existe alguma linha selecionada, faça...
                     {
                         posicaoSelecionada=tbListaFuncionarios.getSelectedRow();
                         // FORNECEDOR SELECIONADO
                         if(listaFuncionarios.get(posicaoSelecionada).getSituacaoFuncionario()=="Demitido")
                         {
                             senha="- - - -";
                         }else
                         {
                             senha=listaFuncionarios.get(posicaoSelecionada).getSituacaoFuncionario();
                         }
                         
                         Calendar calNascimento=listaFuncionarios.get(posicaoSelecionada).getDataNascimentoFuncionario();
                       /* Calendar calAdimssao=listaFuncionarios.get(i).getDataAdamissaoFuncionario();
                        Calendar  calDemssao=listaFuncionarios.get(i).getDataDemissaoFuncionario();
                        Calendar  calAfastamento=listaFuncionarios.get(i).getDataDemissaoFuncionario();
                        Calendar calRetorno=listaFuncionarios.get(i).getDataRetornoFuncionario();
                        */
                            JOptionPane.showMessageDialog(ifTelaFuncionario, 
                            "<HTML>"
                           +"<CENTER> -- <b> DADOS DO FUNCIONARIO -- </b><br><br></CENTER>"
                           +"<table>"
                            +"<tr><td><b>NOME COMPLETO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getNomeFuncionario()+"</td></tr>"
                            +"<tr><td><b>DATA NASCIMENTO:</b></td> <td>"+formatador.format(calNascimento.get(Calendar.DAY_OF_MONTH))+"/"+formatador.format(calNascimento.get(Calendar.MONTH))+"/"+calNascimento.get(Calendar.YEAR)+"</td></tr>" +"</td></tr>"
                            +"<tr><td><b>NÚMERO PIS:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getPisFuncionario()+"</td></tr>"
                            +"<tr><td><b>TELEFONE FIXO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getTelefoneFuncionario()+"</td></tr>"
                            +"<tr><td><b>TELEFONE CELULAR:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getCelularFuncionario()+"</td></tr>"
                            +"<tr><td><b>CEP:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getCepFuncionario()+"</td></tr>"
                            +"<tr><td><b>BAIRRO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getBairroFuncionario()+"</td></tr>"
                            +"<tr><td><b>CIDADE:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getCidadeFuncionario()+"</td></tr>"
                            +"<tr><td><b>ESTADO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getEstadoFuncionario()+"</td></tr>"
                            +"<CENTER> -- <b> DADOS DO FUNCIONAIS -- </b><br><br></CENTER>"
                                    //+formatador.format(cal.get(Calendar.DAY_OF_MONTH))+"/"+formatador.format(cal.get(Calendar.MONTH))+"/"+cal.get(Calendar.YEAR)+"</td></tr>"
                           // +"<tr><td><b>DATA ADMISSÃO: "+listaFuncionarios.get(i).getDataAdamissaoFuncionario()+"</td></tr>"
                           // +"<tr><td><b>DATA DEMISSÃO: "+listaFuncionarios.get(i).getDataDemissaoFuncionario()+"</td></tr>"
                           // +"<tr><td><b>DATA AFASTAMENTO: "+listaFuncionarios.get(i).getDataDemissaoFuncionario()+"</td></tr>"
                           // +"<tr><td><b>DATA RETORNO: "+listaFuncionarios.get(i).getDataRetornoFuncionario()+"</td></tr>"
                            +"<tr><td><b>CARGO ATUAL:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getCargoFuncionario()+"</td></tr>"
                            +"<tr><td><b>NIVEL PERMISSÃO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getPermissaoFuncionario()+"</td></tr>"
                            +"<tr><td><b>NOME USUARIO:</b></td> <td>"+listaFuncionarios.get(posicaoSelecionada).getNomeUsuario()+"</td></tr>"
                            +"<tr><td><b>SENHA:</b></td> <td>"+senha+"</td></tr>"
                            +"</table></html>"
                           );
                     }
                    break;
    ...
    private void miManualUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miManualUsuarioActionPerformed
        // TODO add your handling code here:
        try{
            java.awt.Desktop.getDesktop().open( new File( "manualUsuario.pdf" ) );  
    ...
    private void btAtualizarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarFornecedorActionPerformed
        ...
        if(tbListaFornecedores.getSelectedRow()!=-1) // SE o usuário selecionou uma linha da tabela...
        {
             ...
             btAtualizarFornecedor.setVisible(false); // Tornando invisível o botão ATUALIZAR
             btSalvarFornecedor.setVisible(false);
             btSalvarAtualizarFornecedor.setVisible(true);// Tornando INVISIVEL o botão SalvarFornecedor
             btCancelarFornecedor.setVisible(true);// TORNA VISIVEL O BOTÃO CANCELAR
             ...
             tfRazaoSocialFornecedor.setText(fornecedorAntigo.getRazaoSocialFornecedor().toUpperCase());
             tfNomeFantasiaFornecedor.setText(fornecedorAntigo.getNomeFantasiaFornecedor().toUpperCase());
             ...
             tfLogradouroFornecedor.setText(fornecedorAntigo.getRuaAvnFornecedor().toUpperCase());
             tfNumeroFornecedor.setText(fornecedorAntigo.getNumeroFornecedor());
             tfBairroFornecedor.setText(fornecedorAntigo.getBairroFornecedor().toUpperCase());
             tfCidadeFornecedor.setText(fornecedorAntigo.getCidadeFornecedor().toUpperCase());
             cbEstadoFornecedor.setSelectedItem(fornecedorAntigo.getEstadoFornecedor().toUpperCase());
             tfNomeRepresentanteFornecedor.setText(fornecedorAntigo.getRepresentanteFornecedor().toUpperCase());
             ...
             tfEmailRepresentanteFornecedor.setText(fornecedorAntigo.getEmailRepresentanteFornecedor().toUpperCase());
    ...
    private void btSalvarAtualizarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarAtualizarFornecedorActionPerformed
        ...
        if( resp == 0)
        {
            ...
            if(resp==1)// se precionar NÃO, manter a tela  preenchida
            {
                        tpnAbasFornecedor.setTitleAt(1, "ATUALIZAR");
                        tpnAbasFornecedor.setEnabledAt(1, true); 
                        tpnAbasFornecedor.setEnabledAt(0, false); 
                        btAtualizarFornecedor.setVisible(true);
                        btCancelarFornecedor.setVisible(true);
                        btSalvarFuncionario.setVisible(false);
                        btCancelarFuncionario.setVisible(false); 
            } else
              {   
            if(resp==2)// se precionar CANCELAR, limpar campos e voltar para aba original
                ...
                tpnAbasFornecedor.setEnabledAt(0, true); 
                tpnAbasFornecedor.setEnabledAt(1, true); 
                tpnAbasFornecedor.setTitleAt(1," GERÊNCIAR FORNECEDOR");
               
                btAtualizarFornecedor.setVisible(false);
                btSalvarFornecedor.setVisible(true);
                btLimparCamposFornecedor.setVisible(true);
                btSalvarAtualizarFornecedor.setVisible(false);
                 btCancelarFornecedor.setVisible(false);
    ...
    private void btAtualizarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarFuncionarioActionPerformed
        ...
        if(tbListaFuncionarios.getSelectedRow()!=-1) // SE o usuário selecionou uma linha da tabela...
        {
             tpnAbasFuncionario.setTitleAt(0, "ATUALIZAR DADOS");
             tpnAbasFuncionario.setEnabledAt(1, false);
             btAtualizarFuncionario.setVisible(true); // Tornando visível o botão ATUALIZAR
             btSalvarFuncionario.setVisible(false);// Tornando INVISIVEL o botão SalvarFornecedor
             btCancelarFuncionario.setVisible(true);// TORNA VISIVEL O BOTÃO CANCELAR
             btLimparCamposFuncionario.setVisible(false);// Torna o bt invisivel
             btSalvarAtualizarFuncionario.setVisible(true);
             ...
             ftfDataNascimentoFuncionario.setValue(funcionarioAntigo.getDataNascimentoFuncionario());
    ...
    private void btAtualizarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarClienteActionPerformed
        ...
        if(tbListaClientes.getSelectedRow()!=-1) // SE o usuário selecionou uma linha da tabela...
        {
            ...
            */
             ...
             tfComplementoCliente.setText(clienteAntigo.getComplementoCliente());
    ...
    private void btRemoverProdutoEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverProdutoEstoqueActionPerformed
        /* ALTERAR PARA PRODUTO ESTOQUE
        if(tbListaFornecedores.getSelectedRow()!=-1) // Se existe alguma linha selecionada, faça...
        {
            conexaoTabelaFornecedor.removerFornecedor(modeloTabelaFornecedor.retornalistaFornecedores().get(tbListaFornecedores.getSelectedRow()).getIdFornecedor(),tbListaFornecedores.getValueAt(tbListaFornecedores.getSelectedRow(), 0).toString());
        ...
        */
    }//GEN-LAST:event_btRemoverProdutoEstoqueActionPerformed
    ...
    private void tfBuscaProdutoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfBuscaProdutoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tfBuscaProdutoKeyReleased
    ...
    private void tfBuscaProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfBuscaProdutoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfBuscaProdutoActionPerformed

    public void cpfExistefuncionario()
    {
        listaFuncionarios = conexaoTabelaFuncionario.selecionarTodosFuncionarios();
    ...
    private void btSalvarCliente1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarCliente1ActionPerformed
        
    }//GEN-LAST:event_btSalvarCliente1ActionPerformed

    private void ftfCnpjFornecedorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ftfCnpjFornecedorFocusLost
        listaFornecedores = conexaoTabelaFornecedor.selecionarTodosFornecedores();
        
        for(int i=0; i<listaFornecedores.size();i++)
        {
            if(ftfCnpjFornecedor.getText().equals(listaFornecedores.get(i).getCnpjFornecedor()))
            {
                ftfCpfFuncionario.requestFocus();
                JOptionPane.showMessageDialog(ifTelaFornecedor, "CNPJ EXISTENTE!");
            }
        }
    }//GEN-LAST:event_ftfCnpjFornecedorFocusLost

    private void ftfCpfClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ftfCpfClienteFocusLost
        
    }//GEN-LAST:event_ftfCpfClienteFocusLost
    ...
    private void tfNomeCompletoClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfNomeCompletoClienteFocusLost
        tfNomeCompletoCliente.setCaretPosition(0);
    }//GEN-LAST:event_tfNomeCompletoClienteFocusLost

    private void ftfTelefoneClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ftfTelefoneClienteFocusLost
        ftfTelefoneCliente.setCaretPosition(0);
    }//GEN-LAST:event_ftfTelefoneClienteFocusLost

    private void ftfCelularClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ftfCelularClienteFocusLost
        ftfCelularCliente.setCaretPosition(0);
    }//GEN-LAST:event_ftfCelularClienteFocusLost

    private void tfLogradouroClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfLogradouroClienteFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_tfLogradouroClienteFocusLost

    private void tfNumeroClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfNumeroClienteFocusLost
        tfNumeroCliente.setCaretPosition(0);
    }//GEN-LAST:event_tfNumeroClienteFocusLost

    private void tfComplementoClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfComplementoClienteFocusLost
        tfComplementoCliente.setCaretPosition(0);
    }//GEN-LAST:event_tfComplementoClienteFocusLost

    private void tfEmailClienteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfEmailClienteFocusLost
        tfEmailCliente.setCaretPosition(0);
    }//GEN-LAST:event_tfEmailClienteFocusLost

    private void tbMenusAncestorRemoved(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tbMenusAncestorRemoved
        Point totalX=null;
        //totalX=dpAreaTrabalho.getBaseline();
        System.out.println(totalX);
        tbMenus.setLocation(1199, 1);
    }//GEN-LAST:event_tbMenusAncestorRemoved
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        TelaPizza telaPizza=new TelaPizza(this, true);
        telaPizza.setTitle("CADASTRAR/GERÊNCIAR PIZZAS");
        telaPizza.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void tfNomeUsuarioFuncionarioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfNomeUsuarioFuncionarioKeyReleased
        /* INSERINDO NOME DE USUARIO - PARA ACESSAR AO SISTEMA */
        tfNomeUsuarioFuncionario.setText(tfNomeCompletoFuncionario.getText().toUpperCase());
    }//GEN-LAST:event_tfNomeUsuarioFuncionarioKeyReleased
    ...
    private void tfBairroFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfBairroFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfBairroFornecedorActionPerformed

    private void ftfTelefoneRepresentnteFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfTelefoneRepresentnteFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftfTelefoneRepresentnteFornecedorActionPerformed

    private void ftfCnpjFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfCnpjFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftfCnpjFornecedorActionPerformed

    private void tfNomeCompletoFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNomeCompletoFuncionarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNomeCompletoFuncionarioActionPerformed

    private void ftfCelularRepresentanteFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfCelularRepresentanteFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftfCelularRepresentanteFornecedorActionPerformed

    private void tfRazaoSocialFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfRazaoSocialFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfRazaoSocialFornecedorActionPerformed

    private void tfNomeFantasiaFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNomeFantasiaFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNomeFantasiaFornecedorActionPerformed

    private void ftfTelefoneFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfTelefoneFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftfTelefoneFornecedorActionPerformed

    private void ftfCepFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfCepFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftfCepFornecedorActionPerformed

    private void tfLogradouroFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfLogradouroFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfLogradouroFornecedorActionPerformed

    private void tfNumeroFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNumeroFornecedorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNumeroFornecedorActionPerformed
    ...
    {
        // DEFININDO O CODIGO DO NOVO CLIENTE
        listaClientes = conexaoTabelaCliente.selecionarTodosClientes();
        for(int i=0; i<listaClientes.size(); i++)
        {
                tfIdCliente.setText(listaClientes.size()+1+" ");
        }
        // LIMPANDO CAMPOS
    ...
    public Funcionario retornarDadosPreenchidosFuncionario()
    {
        Funcionario novoFuncionario = new Funcionario();
            ...
            novoFuncionario.setTelefoneFuncionario(ftfTelefoneFuncionario.getValue().toString());
    ...
    private javax.swing.JButton btCancelarCliente1;
    ...
    private javax.swing.JButton btRemoverProdutoEstoque;
    ...
    private javax.swing.JToolBar tbMenus;
